...
namespace AssetLib::Generators
{
    ...
    {
        // NOTE: this stub is from the original VRM-Qavatars mod, not something
        // cut by this port -- VRM 1.0 material generation was never implemented
        // upstream. VRM1 avatars will load with null materials until this is
        // written (would need mapping VRMC_materials_mtoon / PBR fallback onto
        // the mToon shader or an equivalent).
